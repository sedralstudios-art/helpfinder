export const BICYCLE_HELMET_UNDER_14_NY = {
  id: "bicycle-helmet-under-14-ny",
  category: "vehicle",
  tier: "state",
  jurisdiction: "us-ny",
  authorityType: "state-statute",
  primaryStatute: "NY VAT 1238",
  status: "active",

  title: { en: "NY Bicycle Helmet Law — Required for Children Under 14" },

  summary: {
    en: "New York Vehicle and Traffic Law Section 1238 requires a helmet on every cyclist, skateboarder, or roller skater under age 14 on any public road, sidewalk, or path. Adults are not required to wear a helmet. Fines for a child under 14 without a helmet are up to 50 dollars but are often waived when the parent shows proof of helmet purchase. Free helmet programs are available in Monroe County."
  },

  whoQualifies: {
    en: [
      "Any parent or guardian of a child under age 14 who rides a bicycle, skateboard, scooter, or wears inline skates in New York.",
      "A child 1 to 4 years old as a passenger on a parent's bike — also must wear a helmet and be in a secured seat.",
      "A child cyclist ticketed for riding without a helmet.",
      "A parent looking for free or low-cost helmets for a child.",
      "An adult cyclist deciding whether to wear a helmet (not required but strongly recommended)."
    ]
  },
  ...
  yourRights: {
    en: [
      "A parent has the right to a free or low-cost helmet through Monroe County Department of Public Health.",
  ...
  example: {
    en: "The Singh family has two children ages 8 and 11. The 11-year-old was riding her bike in Penfield without a helmet when a sheriff deputy stopped her. The deputy issued a ticket for 50 dollars to the father under VTL 1238. The father bought two CPSC-approved helmets at Walmart the same day for 22 dollars each, brought the receipt to Penfield Town Court, and the judge waived the entire fine. Both children now always ride with helmets."
  },
  ...
  counsel: [
    {
      ...
      focus: "Free child helmet distribution, bicycle safety education",
      qualifier: "Monroe County family with child under 14",
      access: "Phone, walk-in at 111 Westfall Rd",
      outcome: "Free helmet, fit check, safety education",
      phone: "(585) 753-5150",
    ...
    {
      type: "nonprofit",
      name: "Golisano Children's Hospital Injury Prevention Program",
      focus: "Free helmets, fit checks, bicycle and scooter safety education",
  ...
  tags: [
    ...
    "under 14 helmet",
    "CPSC bike helmet",
    "free helmet Monroe County",
    "child bike safety",
    "helmet fit",
    "skateboard helmet NY",
    "scooter helmet child"
  ],
