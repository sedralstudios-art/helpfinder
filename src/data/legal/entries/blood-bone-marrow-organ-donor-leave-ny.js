export const BLOOD_BONE_MARROW_ORGAN_DONOR_LEAVE_NY = {
  id: "blood-bone-marrow-organ-donor-leave-ny",
  category: "employment",
  tier: "state",
  jurisdiction: "us-ny",
  authorityType: "state-statute",
  primaryStatute: "NY LAB 202-a",
  status: "active",
  ...
  whoQualifies: {
    en: [
      "Any NY employee at a company with at least 20 full-time employees working at least 20 hours per week.",
      "A blood donor at a Red Cross or other blood drive.",
      "A bone marrow donor registered with the National Marrow Donor Program.",
      "An organ donor (kidney, liver, or partial organ).",
      "An employee who is being called to donate after registry match."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Labor Law 202-a/b/c donor leave enforcement, retaliation complaints",
      qualifier: "Any NY employee",
      access: "Phone, online complaint form",
      outcome: "Complaint investigation, employer compliance, damages",
      phone: "(888) 469-7365",
    ...
    },
    {
      ...
      focus: "Employment retaliation including donor-leave retaliation",
