export const CELL_PHONE_WHILE_DRIVING_NY = {
  id: "cell-phone-while-driving-ny",
  category: "vehicle",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  title: { en: "Cell Phone and Texting While Driving — NY Vehicle and Traffic Law Rules and Penalties" },

  summary: {
    en: "New York prohibits any use of a handheld phone while driving under VTL 1225-c (handheld ban) and bans texting or any portable electronic device use under VTL 1225-d. Hands-free use is permitted. Violations carry fines, points on license, and surcharges. Commercial drivers and novice drivers face stricter rules. A conviction can raise insurance rates significantly. Emergency calls to 911 and certain other exceptions apply."
  },

  whoQualifies: {
    en: [
      "Any driver on NY public roads who uses a cell phone while the vehicle is in motion.",
      "A driver stopped at a traffic signal or in traffic who picks up their phone (still in motion for VTL purposes).",
      "A commercial driver subject to federal and state stricter rules.",
      "A junior or learner driver (Class DJ) facing automatic license suspension on conviction.",
      "A parent of a teen driver who received a cell phone ticket.",
      "A driver ticketed for a cell phone violation disputing the stop."
    ]
  },
  ...
  yourRights: {
    en: [
      "A driver has the right to hands-free phone use while driving (VTL 1225-c).",
      "A driver has the right to make emergency calls to 911 and emergency services without violation.",
      "A driver has the right to use the phone while lawfully stopped off the roadway.",
      "A driver ticketed has the right to plead not guilty and contest in traffic court.",
      "A driver has the right to request officer notes and body-camera footage.",
      "A driver has the right to an attorney for traffic court representation.",
      "A commercial driver has the right to an administrative hearing before CDL suspension.",
      "A junior driver has the right to driver-improvement course credit toward points reduction."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "Insurance Information Institute at (800) 942-4242 — insurance impact questions.",
      "AAA Mid-Atlantic Member Services at (800) 222-1469."
    ]
  },

  example: {
    en: "A Rochester driver received a VTL 1225-c ticket from a Monroe County Sheriff for holding her phone at a red light. She pleaded not guilty. In traffic court she presented evidence: her phone had been connected via Bluetooth to the vehicle's infotainment system and a screen capture showed the phone's call log at the moment of the stop with no call active. The officer's body-camera footage was inconclusive — the officer could not clearly see the phone. The judge reduced the ticket to a non-moving violation with a small fine and no points, protecting her insurance from an increase. She spent about $180 in attorney fees to avoid what would have been over $2,000 in insurance premium increase over 3 years."
  },
  ...
  counsel: [
    {
      ...
      focus: "Traffic tickets, VTL 1225-c defense, plea reductions",
      qualifier: "Any Monroe County driver",
      access: "Phone at (585) 546-2130",
      outcome: "30-minute consultation, then flat or hourly traffic court representation",
      phone: "(585) 546-2130",
