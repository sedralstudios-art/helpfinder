export const CONSUMER_CREDIT_LAWSUIT_DEFENSE_NY = {
  id: "consumer-credit-lawsuit-defense-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  summary: {
    en: "The New York Consumer Credit Fairness Act (CCFA), enacted in 2021 and effective 2022, shortened the statute of limitations on consumer credit debt from 6 years to 3 years, added strict procedural requirements for debt-buyer lawsuits, and gives a person sued on an old credit card balance strong defenses. Many debt-buyer cases are now vulnerable to dismissal because the debt is time-barred, the complaint lacks required documentation, or the plaintiff cannot prove chain of ownership."
  },

  whoQualifies: {
    en: [
      "A person served with a summons and complaint by a credit card company, debt buyer, or collection law firm.",
      "A person with a default judgment entered against them for consumer debt they do not recognize or that is old.",
      "A person with wages being garnished or a bank account frozen based on an old consumer debt.",
      "A person receiving court papers for a debt that was charged off many years ago.",
      "A cosigner or authorized user on a debt originating with another person.",
      "A person who has been sued before by a different collector on the same debt."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "A consumer has the right to move to vacate a default judgment for excusable default and meritorious defense (CPLR 5015).",
      "A consumer has the right to exempt income protection under CPLR 5222-a if served with a restraining notice.",
      "A consumer cannot be arrested for civil debt."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "NY Attorney General Consumer Frauds at (800) 771-7755 — state enforcement."
    ]
  },
  ...
  counsel: [
    {
      ...
      focus: "Consumer debt defense, default judgment vacatur, CCFA motions",
      qualifier: "Low-income Monroe County residents",
      access: "Phone at (585) 232-4090",
      outcome: "Full defense representation or strategic advice",
      phone: "(585) 232-4090",
