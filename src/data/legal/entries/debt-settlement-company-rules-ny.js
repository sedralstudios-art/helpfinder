export const DEBT_SETTLEMENT_COMPANY_RULES_NY = {
  id: "debt-settlement-company-rules-ny",
  category: "consumer",
  tier: "state",
  jurisdiction: "us-ny",
  ...
  whoQualifies: {
    en: [
      "Any consumer considering signing with a debt settlement company.",
      "Any consumer already in a debt settlement program who wants to understand their rights.",
      "Any consumer whose credit was damaged and whose debts were sued on while in a debt settlement program.",
      "Any consumer received a 1099-C for forgiven debt from a settlement."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "Alternatives (nonprofit credit counseling, DMP, bankruptcy) are available and often better for consumers."
    ]
  },
  ...
  legalOptions: {
    en: [
      ...
      "For complaints about a debt settlement company: FTC at reportfraud.ftc.gov, CFPB at consumerfinance.gov, NY AG at (800) 771-7755.",
      "If sued by a creditor while in a debt settlement program, do not ignore the lawsuit — respond within the time period and get legal help. Free legal help: Legal Aid Society of Rochester at (585) 232-4090.",
      "For tax consequences of forgiven debt: a 1099-C may result in taxable income. Low Income Taxpayer Clinic at Legal Aid can advise on the insolvency exclusion (IRC 108)."
    ]
  },

  example: {
    en: "A Rochester consumer had $42,000 in credit card debt across five accounts. A debt settlement company promised to reduce the debt to about $20,000 over 36 months. She stopped paying creditors and started making $600 monthly payments to an escrow account. Within 10 months her credit score dropped from 680 to 510, two creditors had sued her, and she was served with wage-garnishment paperwork. She consulted Legal Aid, which referred her to Consumer Credit Counseling Service. CCCS negotiated a Debt Management Plan with her creditors at reduced interest. She paid about $1,100 per month for 48 months through the DMP and kept her accounts current. Total paid: about $53,000. With the debt settlement approach her actual out-of-pocket plus damage (credit repair, garnishments, tax liability on the forgiven amount) would have been similar or higher with far worse credit."
  },
  ...
  counsel: [
    {
      ...
      focus: "Nonprofit credit counseling, Debt Management Plans, budgeting",
      qualifier: "Any consumer with credit card or consumer debt",
      access: "Phone at (585) 546-3440",
      outcome: "Credit counseling, DMP enrollment, budgeting education",
      phone: "(585) 546-3440",
    ...
    },
    {
      ...
      focus: "Debt settlement company complaints, unfair and deceptive practices",
  ...
  tags: [
    ...
    "debt negotiation scam",
    "debt settlement fees",
    "debt settlement lawsuit"
  ],

  sources: [
    "https://www.nysenate.gov/legislation/laws/GBS/456",
    "https://www.law.cornell.edu/cfr/text/16/part-310",
