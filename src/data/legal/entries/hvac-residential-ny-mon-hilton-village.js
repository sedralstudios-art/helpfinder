export const HVAC_RESIDENTIAL_NY_MON_HILTON_VILLAGE = {
  ...
  whoQualifies: {
    en: [
      ...
      "A homeowner considering self-work who is confirming the village's rule with CEO Mark Mazzucco."
    ]
  },
  ...
  yourRights: {
    en: [
      ...
      "A property owner has the right to a clear answer on jurisdiction — Hilton village or Town of Parma — for a specific address.",
      "State worker protections — wage, safety, injury — apply in Hilton village as statewide.",
  ...
  legalOptions: {
    en: [
      "The Village of Hilton Building Department at (585) 392-4144 ext 106 handles HVAC permits and inspections.",
      ...
      "For addresses outside village limits, the Town of Parma Building Department handles the permit.",
  ...
  counsel: [{
    ...
    qualifier: "Residents and contractors working in Village of Hilton",
    access: "Phone",
  ...
  sources: ["https://hiltonny.gov/html/building-dept.html", "https://ecode360.com/8009030"],
