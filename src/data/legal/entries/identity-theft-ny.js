export const IDENTITY_THEFT_NY = {
  ...
  summary: {
    en: "When someone opens accounts, takes out loans, files taxes, or commits crimes using another person's personal information, that is identity theft. New York has strong identity theft protections. You have the right to a police report, a credit freeze, and free legal help to clean up the damage."
  },
