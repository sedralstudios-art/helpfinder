export const ROBOCALL_DONOTCALL_NY = {
  ...
  whatItMeans: {
    en: "Under the Telephone Consumer Protection Act (47 USC § 227) and FCC regulations, it is illegal to make robocalls (pre-recorded marketing calls) to cell phones without prior written consent. Telemarketers must honor the National Do Not Call Registry — if a number is registered and a telemarketer calls anyway (with limited exceptions), that is a violation. Each violation can result in damages to the consumer. Scam calls — impersonating the IRS, SSA, a utility company, a bank, or law enforcement — are illegal under both the TCPA and New York GBL § 349 (deceptive practices). No government agency calls to demand immediate payment by gift card, wire transfer, or cryptocurrency. Legitimate agencies send written notices. Registering on the Do Not Call list is free and takes about a month to take effect. It does not stop calls from political campaigns, charities, surveys, or companies with which you have an existing business relationship."
  },
